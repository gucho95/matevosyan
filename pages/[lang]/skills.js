    ...
    <Layout>
      <div className='flex flex-wrap justify-start gap-6 py-16'>
        {skills.map((skill, key) => (
          <div className=' flex justify-center items-center flex-col  w-150px shadow-xs border-2 border-transparent  transition-all duration-500 hover:animate-border select-none'>
