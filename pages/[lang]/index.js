    ...
    <Layout>
      <div className='flex  xl:justify-around py-8 xl:flex-row xs:flex-col xs:justify-center xs:text-sm md:text-base'>
        <div className='flex flex-col  xl:items-start xs:items-center '>
          <h1 className='md:text-3xl xs:text-2xl font-bold' itemProp='name'>
            {t("common:name")}
          </h1>
          <ul>
            <li className='mt-2' itemProp='jobTitle'>
              <Point icon='code' text={t("common:position")} />
            </li>
            <li className='mt-2' itemProp='birthDate'>
              <Point icon='date' text='05/11/1995' />
            </li>
            <li className='mt-2' itemProp='address'>
        ...
        <div className='uppercase xs:mt-16 xl:mt-0 xs:text-xs md:text-base'>
          <div className='border-b-2 border-gray-200 pb-4' itemProp='affiliation'>
          ...
          <div className='mt-8 border-b-2 border-gray-200 pb-4' itemProp='affiliation'>
